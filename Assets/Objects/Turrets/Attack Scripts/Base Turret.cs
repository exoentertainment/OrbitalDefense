...
public class BaseTurret : MonoBehaviour
{
    ...
    {
        Debug.DrawRay(raycastOrigin.position, raycastOrigin.forward * turretSO.projectileSO.range, Color.red);;
        if (target != null)
        {
    ...
    protected virtual bool IsLoSClear()
    {
        ...
        //     // {
        //     //     if (hit.collider.gameObject.layer == LayerMask.NameToLayer("Weapon Platform"))
        //     //     {
        //     //         lastTimeOnTarget = Time.time;
        //     //         return true;
        //     //     }
        //     // }
        //     // else if (gameObject.layer == LayerMask.NameToLayer("Weapon Platform"))
        //     // {
        ...
        if(Physics.Raycast(raycastOrigin.position, raycastOrigin.forward * turretSO.projectileSO.range, out RaycastHit hit, turretSO.projectileSO.range, turretSO.targetLayers))
        {
            // if (gameObject.layer == LayerMask.NameToLayer("Enemy"))
            // {
            //     if (hit.collider.gameObject.layer == LayerMask.NameToLayer("Weapon Platform"))
