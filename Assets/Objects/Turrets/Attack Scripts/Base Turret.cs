...
public class BaseTurret : MonoBehaviour
{
    ...
    protected virtual IEnumerator FireRoutine()
    {
        ...
        // shootingAngle.eulerAngles = new Vector3(platformTurret.rotation.eulerAngles.x + turretSO.GetTrackingError(), platformTurret.rotation.eulerAngles.y + turretSO.GetTrackingError(), 0);
        shootingAngle.eulerAngles = new Vector3(raycastOrigin.rotation.eulerAngles.x + turretSO.GetTrackingError(), raycastOrigin.rotation.eulerAngles.y + turretSO.GetTrackingError(), 0);
